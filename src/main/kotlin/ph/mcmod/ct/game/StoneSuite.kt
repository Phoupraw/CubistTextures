...
class StoneSuite(path: String, chinese: String, mapColor: MapColor, luminance: Int = 0) : SlabStairsSuite(path, chinese, mapColor, luminance, arrayOf(STONE, STONE_SLAB, STONE_STAIRS)) {
	...
	@Suppress("unused")
	companion object {
		@JvmField val BLAST_FURNACE_STONE = StoneSuite("blast_furnace_stone", "高炉石", BLAST_FURNACE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(BLAST_FURNACE, fullBlock, 16)
			}
		}
		@JvmField val BORDERED_BLAST_FURNACE_STONE = StoneSuite("bordered_blast_furnace_stone", "边框高炉石", BLAST_FURNACE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(BLAST_FURNACE, fullBlock, 16)
			}
		}
		@JvmField val DARK_BLAST_FURNACE_STONE = StoneSuite("dark_blast_furnace_stone", "暗高炉石", BLAST_FURNACE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(BLAST_FURNACE, fullBlock, 16)
			}
		}
		@JvmField val CHISELED_DARK_BLAST_FURNACE_STONE = StoneSuite("chiseled_dark_blast_furnace_stone", "錾制暗高炉石", BLAST_FURNACE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(BLAST_FURNACE, fullBlock, 16)
			}
		}
		@JvmField val LIGHT_BLAST_FURNACE_STONE = StoneSuite("light_blast_furnace_stone", "浅高炉石", BLAST_FURNACE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(BLAST_FURNACE, fullBlock, 16)
			}
		}
		@JvmField val BORDERED_LIGHT_BLAST_FURNACE_STONE = StoneSuite("bordered_light_blast_furnace_stone", "边框浅高炉石", BLAST_FURNACE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(BLAST_FURNACE, fullBlock, 16)
			}
		}
		@JvmField val PV_STONE = StoneSuite("pv_stone", "光伏石", DAYLIGHT_DETECTOR.defaultMapColor, 4).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(DAYLIGHT_DETECTOR, fullBlock, 9)
			}
		}
		@JvmField val BORDERED_PV_STONE = StoneSuite("bordered_pv_stone", "边框光伏石", DAYLIGHT_DETECTOR.defaultMapColor, 4).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(DAYLIGHT_DETECTOR, fullBlock, 9)
			}
		}
		@JvmField val DARK_PV_STONE = StoneSuite("dark_pv_stone", "暗光伏石", DAYLIGHT_DETECTOR.defaultMapColor, 3).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(DAYLIGHT_DETECTOR, fullBlock, 9)
			}
		}
		@JvmField val BORDERED_DARK_PV_STONE = StoneSuite("bordered_dark_pv_stone", "边框暗光伏石", DAYLIGHT_DETECTOR.defaultMapColor, 3).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(DAYLIGHT_DETECTOR, fullBlock, 9)
			}
		}
		@JvmField val MECHANICAL_STONE = StoneSuite("mechanical_stone", "机械石", DISPENSER.defaultMapColor).apply {
			if (ARRP) {
				stoneCutMechanical(fullBlock)
			}
		}
		@JvmField val BORDERED_MECHANICAL_STONE = StoneSuite("bordered_mechanical_stone", "边框机械石", DISPENSER.defaultMapColor).apply {
			if (ARRP) {
				stoneCutMechanical(fullBlock)
			}
		}
		@JvmField val DARK_MECHANICAL_STONE = StoneSuite("dark_mechanical_stone", "暗机械石", DISPENSER.defaultMapColor).apply {
			if (ARRP) {
				stoneCutMechanical(fullBlock)
			}
		}
		@JvmField val BORDERED_DARK_MECHANICAL_STONE = StoneSuite("bordered_dark_mechanical_stone", "边框暗机械石", DISPENSER.defaultMapColor).apply {
			if (ARRP) {
				stoneCutMechanical(fullBlock)
			}
		}
		@JvmField val LIGHT_MECHANICAL_STONE = StoneSuite("light_mechanical_stone", "浅机械石", DISPENSER.defaultMapColor).apply {
			if (ARRP) {
				stoneCutMechanical(fullBlock)
			}
		}
		@JvmField val BORDERED_LIGHT_MECHANICAL_STONE = StoneSuite("bordered_light_mechanical_stone", "边框浅机械石", DISPENSER.defaultMapColor).apply {
			if (ARRP) {
				stoneCutMechanical(fullBlock)
			}
		}
		@JvmField val BORDERED_CRYING_OBSIDIAN = StoneSuite("bordered_crying_obsidian", "边框哭泣的黑曜石", RESPAWN_ANCHOR.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(RESPAWN_ANCHOR, fullBlock, 9)
			}
		}
		@JvmField val CUT_CRYING_OBSIDIAN = StoneSuite("cut_crying_obsidian", "切制哭泣的黑曜石", RESPAWN_ANCHOR.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(RESPAWN_ANCHOR, fullBlock, 9)
			}
		}
		@JvmField val CRYING_OBSIDIAN_LAMP = StoneSuite("crying_obsidian_lamp", "哭泣的黑曜石灯", RESPAWN_ANCHOR.defaultMapColor, 15).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(RESPAWN_ANCHOR, fullBlock, 9)
			}
		}
		@JvmField val BORDERED_END_STONE = StoneSuite("bordered_end_stone", "边框末地石", END_STONE_BRICKS.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(END_STONE_BRICKS, fullBlock, 1)
			}
		}
		@JvmField val CHISELED_END_STONE = StoneSuite("chiseled_end_stone", "錾制末地石", END_STONE_BRICKS.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(END_STONE_BRICKS, fullBlock, 1)
			}
		}
		@JvmField val SMOKER_STONE = StoneSuite("smoker_stone", "烟熏石", SMOKER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(SMOKER, fullBlock, 12)
			}
		}
		@JvmField val BORDERED_SMOKER_STONE = StoneSuite("bordered_smoker_stone", "边框烟熏石", SMOKER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(SMOKER, fullBlock, 12)
			}
		}
		@JvmField val OBSERVER_STONE = StoneSuite("observer_stone", "侦测石", OBSERVER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(OBSERVER, fullBlock, 9)
			}
		}
		@JvmField val BORDERED_OBSERVER_STONE = StoneSuite("bordered_observer_stone", "边框侦测石", OBSERVER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(OBSERVER, fullBlock, 9)
			}
		}
		@JvmField val LIGHT_BORDERED_OBSERVER_STONE = StoneSuite("light_bordered_observer_stone", "浅边框侦测石", OBSERVER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(OBSERVER, fullBlock, 9)
			}
		}
		@JvmField val SIMITHING_STONE = StoneSuite("smithing_stone", "锻造石", SMITHING_TABLE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(SMITHING_TABLE, fullBlock, 6)
			}
		}
		@JvmField val BORDERED_SIMITHING_STONE = StoneSuite("bordered_smithing_stone", "边框锻造石", SMITHING_TABLE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(SMITHING_TABLE, fullBlock, 6)
			}
		}
		@JvmField val CUT_SIMITHING_STONE = StoneSuite("cut_smithing_stone", "切制锻造石", SMITHING_TABLE.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(SMITHING_TABLE, fullBlock, 6)
				cut(SIMITHING_STONE.fullBlock, fullBlock)
			}
		}
		@JvmField val ENCHANTING_TABLE_STONE = StoneSuite("enchanting_table_stone", "附魔台石", CAMPFIRE.defaultMapColor, 8).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(ENCHANTING_TABLE, fullBlock, 32)
			}
		}
		@JvmField val FLOWER_POT_STONE = StoneSuite("flower_pot_stone", "花盆石", FLOWER_POT.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(FLOWER_POT, fullBlock, 1)
			}
		}
		@JvmField val STRUCTRURE_SAVE_STONE = StoneSuite("structure_save_stone", "结构保存石", STRUCTURE_BLOCK.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(PURPLE_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val STRUCTRURE_LOAD_STONE = StoneSuite("structure_load_stone", "结构加载石", STRUCTURE_BLOCK.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(PURPLE_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val STRUCTRURE_CORNER_STONE = StoneSuite("structure_corner_stone", "结构角落石", STRUCTURE_BLOCK.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(PURPLE_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val STRUCTRURE_DATA_STONE = StoneSuite("structure_data_stone", "结构数据石", STRUCTURE_BLOCK.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(PURPLE_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val STRUCTRURE_ITEM_STONE = StoneSuite("structure_item_stone", "结构物品石", STRUCTURE_BLOCK.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(PURPLE_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val GOLD_AXOLOTL_STONE = StoneSuite("gold_axolotl_stone", "金美西螈石", YELLOW_GLAZED_TERRACOTTA.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(YELLOW_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val BLUE_AXOLOTL_STONE = StoneSuite("blue_axolotl_stone", "蓝美西螈石", BLUE_GLAZED_TERRACOTTA.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(BLUE_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val CYAN_AXOLOTL_STONE = StoneSuite("cyan_axolotl_stone", "青美西螈石", CYAN_GLAZED_TERRACOTTA.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(CYAN_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val BROWN_AXOLOTL_STONE = StoneSuite("brown_axolotl_stone", "棕美西螈石", BROWN_GLAZED_TERRACOTTA.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(BROWN_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val PINK_AXOLOTL_STONE = StoneSuite("pink_axolotl_stone", "粉美西螈石", PINK_GLAZED_TERRACOTTA.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(PINK_GLAZED_TERRACOTTA, fullBlock, 1)
			}
		}
		@JvmField val HOPPER_STONE = StoneSuite("hopper_stone", "漏斗石", HOPPER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(HOPPER, fullBlock, 13)
			}
		}
		@JvmField val CUT_HOPPER_STONE = StoneSuite("cut_hopper_stone", "切制漏斗石", HOPPER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(HOPPER, fullBlock, 13)
				cut(HOPPER_STONE.fullBlock, fullBlock)
			}
		}
		@JvmField val ENDER_CHEST_LAMP = StoneSuite("ender_chest_lamp", "末影箱灯", ENDER_CHEST.defaultMapColor, 15).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(ENDER_CHEST, fullBlock, 9)
			}
		}
		@JvmField val ENDER_CHEST_STONE = StoneSuite("ender_chest_stone", "末影箱石", ENDER_CHEST.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(ENDER_CHEST, fullBlock, 9)
			}
		}
		@JvmField val CUT_ENDER_CHEST_STONE = StoneSuite("cut_ender_chest_stone", "切制末影箱石", ENDER_CHEST.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(ENDER_CHEST, fullBlock, 9)
				cut(ENDER_CHEST_STONE.fullBlock, fullBlock)
			}
		}
		@JvmField val CHISELED_ENDER_CHEST_STONE = StoneSuite("chiseled_ender_chest_stone", "錾制末影箱石", ENDER_CHEST.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(ENDER_CHEST, fullBlock, 9)
			}
		}
		...
		@JvmField val CUTTING_STONE = StoneSuite("cutting_stone", "切割石", STONECUTTER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(STONECUTTER, fullBlock, 4)
			}
		}
		@JvmField val CUT_CUTTING_STONE = StoneSuite("cut_cutting_stone", "切制切割石", STONECUTTER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(STONECUTTER, fullBlock, 4)
				cut(CUTTING_STONE.fullBlock, fullBlock)
			}
		}
		@JvmField val DARK_SMOOTH_STONE = StoneSuite("dark_smooth_stone", "暗平滑石", STONECUTTER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(STONECUTTER, fullBlock, 4)
			}
		}
		@JvmField val CHISELED_CUTTING_STONE = StoneSuite("chiseled_cutting_stone", "錾制切割石", STONECUTTER.defaultMapColor).apply {
			if (ARRP) {
				ARRP_HELPER.pack.addRecipe_stoneCutting(STONECUTTER, fullBlock, 4)
			}
		}
