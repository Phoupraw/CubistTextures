...
object SynopsisTooltip {
	 ...
	 */
	@JvmField
	val TAG: TagKey<Item> = TagKey.of(Registry.ITEM.key, Identifier(NAMESPACE, PATH))
	private val J_TAG: JTag = JTag.tag()
	private val J_TAG_SET = mutableSetOf<Item>()
	
	init {
		ARRP_HELPER.tags[Identifier(NAMESPACE, "items/$PATH")] = J_TAG
	}
	/**
	 * 添加简介
	 * @param item 物品
	 ...
	 * @see ph.mcmod.ct.mixin.MixinItem.addSynopsis
	 */
	@JvmStatic
